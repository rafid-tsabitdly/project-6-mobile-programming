...
class _ProfilePageState extends State<ProfilePage> {
  // Data profil
  String name = 'M. Rafid Tsabitdly';
  String bio =
      'I am a fourth-semester Information Systems student at Pamulang University and the founder of a business in the telecommunications sector. My academic journey, combined with entrepreneurial experience, has shaped my interest in technology, business strategy, and digital innovation.'
  ...
  String email = 'tsabitdly@gmail.com';
  String phone = '+62 813-9847-2004';
  String birthday = 'July 10, 2005';
  String occupation = 'System Information at Universitas Pamulang';
                ...
                child: Stack(
                  ...
                  children: [
                    Opacity(
                      opacity: 0.9,
                      child: Image.network(
                        'https://media.licdn.com/dms/image/v2/D5616AQFQ-5whuUIUMw/profile-displaybackgroundimage-shrink_350_1400/profile-displaybackgroundimage-shrink_350_1400/0/1729172902860?e=1778716800&v=beta&t=bENEvJ_r69L92MCJITBu5F0Hv8BsU5FpC0060vRUsz4',
                        fit: BoxFit.cover,
                      ),
                    ),
                    Column(
  ...
  ImageProvider _getAvatarImage() {
    if (avatarFile != null) {
      ...
      return const NetworkImage(
        'https://media.licdn.com/dms/image/v2/D5603AQE9Et_ZG6Rgnw/profile-displayphoto-shrink_800_800/B56ZQWuWq0HIAc-/0/1735548038326?e=1778716800&v=beta&t=88hQgbqyphZEeB1kNN8v1MBHTkfVlh9aGA5WrVy1ALk',
      );
    }
  }
